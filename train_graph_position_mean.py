...
if __name__ == '__main__':
    # Load Config
    config_file_path = 'config/s3dis/s3dis_antenna_graph_position_mean.yaml'  # YAML config file
    ...
    elif arch == 'pointNN_graph_position_mean':
        from model.pointNN_graph_position_mean import NN as Model
    else: 
